...
const wire = createInputCodec({ magic: 0x31424343, version: 1, width: 640, height: 480, look: true });
...
codec.parameters.properties.actions.items.properties.type.description =
  ...
  "move: absolute x,y in menus; drag: x,y,end_x,end_y,button; key: key and optional modifiers; wait: milliseconds.";
