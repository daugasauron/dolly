(module
  ...
  (import "env" "fprintf" (func $fprintf (param i64 i64 i64) (result i32)))
  ...
  (import "env" "printf" (func $printf (param i64 i64) (result i32)))
  ...
  (import "env" "isascii" (func $isascii (param i32) (result i32)))
  ...
  (import "env" "memcpy" (func $memcpy (param i64 i64 i64) (result i64)))
  (import "env" "memset" (func $memset (param i64 i32 i64) (result i64)))
  ...
  (import "env" "sprintf" (func $sprintf (param i64 i64 i64) (result i32)))
