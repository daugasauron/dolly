...
All 19 images passed packaged inventories and 266 source tests pass; browser checks
validate the build-stdin fix, including Studio, Python, Pi, Neovim and Git.
Application `9e1671f` is published locally on port 9000. Pi edits now reject
...
- [ ] Finish the source/artifact/privacy review. All images and relevant browser
  ...
  staging copies; browser tests respect live profile locks. Dollar-containing
  Janis export paths and lint filenames remain confirmed follow-ups.
...
Port 9000 remains available. Around 2 GiB of disk remains; no large rebuilds.
